...
selected_brands = st.sidebar.multiselect(
    ...
    default=['Apple', 'Samsung', 'Google', 'OnePlus', 'Xiaomi', 'Huawei']
)
...
fig3 = px.imshow(
    ...
    title='Sentiment Heatmap: Brand x Topic',
    aspect='auto'
)
...
fig5 = px.bar(
    ...
    title='Sentiment Lift When Feature is
cat > streamlit_app/app.py << 'PYEOF'
import streamlit as st
import pandas as pd
import plotly.express as px
import plotly.graph_objects as go
